...
public class Category_Vitamins extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category__vitamins);
        ...
        sliderLayout=findViewById(R.id.vitamin_sliderlayout);
    ...
    public void slideshow()
    {
        for(int i=1;i<=3;i++)
        {
            ...
            {
                case 1:
                    sliderView.setImageDrawable(R.drawable.vitamin_advertisement);
                    break;
                case 2:
    ...
    {
        product_name_1=findViewById(R.id.category_vitamin_name_1);
        product_price_1=findViewById(R.id.category_vitamin_price_1);
        product_offer_1=findViewById(R.id.category_vitamin_offer_1);
        product_image_1=findViewById(R.id.category_vitamin_image_1);
        product_button_1=findViewById(R.id.category_vitamin_button_1);
    ...
    {
        product_name_2=findViewById(R.id.category_vitamin_name_2);
        product_price_2=findViewById(R.id.category_vitamin_price_2);
        product_offer_2=findViewById(R.id.category_vitamin_offer_2);
        product_image_2=findViewById(R.id.category_vitamin_image_2);
        product_button_2=findViewById(R.id.category_vitamin_button_2);
    ...
    {
        product_name_3=findViewById(R.id.category_vitamin_name_3);
        product_price_3=findViewById(R.id.category_vitamin_price_3);
        product_offer_3=findViewById(R.id.category_vitamin_offer_3);
        product_image_3=findViewById(R.id.category_vitamin_image_3);
        product_button_3=findViewById(R.id.category_vitamin_button_3);
    ...
    {
        product_name_4=findViewById(R.id.category_vitamin_name_4);
        product_price_4=findViewById(R.id.category_vitamin_price_4);
        product_offer_4=findViewById(R.id.category_vitamin_offer_4);
        product_image_4=findViewById(R.id.category_vitamin_image_4);
        product_button_4=findViewById(R.id.category_vitamin_button_4);
    ...
    public void btn_showMessage(View view, final String item_name, final String item_price, final String item_offer, final ImageView item_image){
        final AlertDialog.Builder alert = new AlertDialog.Builder(Category_Vitamins.this);
