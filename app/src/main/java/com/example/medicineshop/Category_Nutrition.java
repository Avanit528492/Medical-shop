...
public class Category_Nutrition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category__nutrition);
        db= new SQLitedatabase(this);


        //slideshow

        sliderLayout=findViewById(R.id.nutrition_sliderlayout);
    ...
    public void slideshow()
    {
        for(int i=1;i<=3;i++)
        {
            ...
            {
                case 1:
                    sliderView.setImageDrawable(R.drawable.nutrition_advertisement_1);
                    break;
                case 2:
                    sliderView.setImageDrawable(R.drawable.nutrition_advertisement_2);
                    break;
                case 3:
    ...
    {
        product_name_1=findViewById(R.id.category_nutrition_name_1);
        product_price_1=findViewById(R.id.category_nutrition_price_1);
        product_offer_1=findViewById(R.id.category_nutrition_offer_1);
        product_image_1=findViewById(R.id.category_nutrition_image_1);
        product_button_1=findViewById(R.id.category_nutrition_button_1);
    ...
    {
        product_name_2=findViewById(R.id.category_nutrition_name_2);
        product_price_2=findViewById(R.id.category_nutrition_price_2);
        product_offer_2=findViewById(R.id.category_nutrition_offer_2);
        product_image_2=findViewById(R.id.category_nutrition_image_2);
        product_button_2=findViewById(R.id.category_nutrition_button_2);
    ...
    {
        product_name_3=findViewById(R.id.category_nutrition_name_3);
        product_price_3=findViewById(R.id.category_nutrition_price_3);
        product_offer_3=findViewById(R.id.category_nutrition_offer_3);
        product_image_3=findViewById(R.id.category_nutrition_image_3);
        product_button_3=findViewById(R.id.category_nutrition_button_3);
    ...
    {
        product_name_4=findViewById(R.id.category_nutrition_name_4);
        product_price_4=findViewById(R.id.category_nutrition_price_4);
        product_offer_4=findViewById(R.id.category_nutrition_offer_4);
        product_image_4=findViewById(R.id.category_nutrition_image_4);
        product_button_4=findViewById(R.id.category_nutrition_button_4);
    ...
    {
        product_name_5=findViewById(R.id.category_nutrition_name_5);
        product_price_5=findViewById(R.id.category_nutrition_price_5);
        product_offer_5=findViewById(R.id.category_nutrition_offer_5);
        product_image_5=findViewById(R.id.category_nutrition_image_5);
        product_button_5=findViewById(R.id.category_nutrition_button_5);
    ...
    {
        product_name_6=findViewById(R.id.category_nutrition_name_6);
        product_price_6=findViewById(R.id.category_nutrition_price_6);
        product_offer_6=findViewById(R.id.category_nutrition_offer_6);
        product_image_6=findViewById(R.id.category_nutrition_image_6);
        product_button_6=findViewById(R.id.category_nutrition_button_6);
    ...
    {
        product_name_7=findViewById(R.id.category_nutrition_name_7);
        product_price_7=findViewById(R.id.category_nutrition_price_7);
        product_offer_7=findViewById(R.id.category_nutrition_offer_7);
        product_image_7=findViewById(R.id.category_nutrition_image_7);
        product_button_7=findViewById(R.id.category_nutrition_button_7);
    ...
    {
        product_name_8=findViewById(R.id.category_nutrition_name_8);
        product_price_8=findViewById(R.id.category_nutrition_price_8);
        product_offer_8=findViewById(R.id.category_nutrition_offer_8);
        product_image_8=findViewById(R.id.category_nutrition_image_8);
        product_button_8=findViewById(R.id.category_nutrition_button_8);
    ...
    {
        product_name_9=findViewById(R.id.category_nutrition_name_9);
        product_price_9=findViewById(R.id.category_nutrition_price_9);
        product_offer_9=findViewById(R.id.category_nutrition_offer_9);
        product_image_9=findViewById(R.id.category_nutrition_image_9);
        product_button_9=findViewById(R.id.category_nutrition_button_9);
    ...
    {
        product_name_10=findViewById(R.id.category_nutrition_name_10);
        product_price_10=findViewById(R.id.category_nutrition_price_10);
        product_offer_10=findViewById(R.id.category_nutrition_offer_10);
        product_image_10=findViewById(R.id.category_nutrition_image_10);
        product_button_10=findViewById(R.id.category_nutrition_button_10);
    ...
    public void btn_showMessage(View view, final String item_name, final String item_price, final String item_offer, final ImageView item_image){
        final AlertDialog.Builder alert = new AlertDialog.Builder(Category_Nutrition.this);
